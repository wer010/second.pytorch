...
import sys
sys.path.append('/home/lichao/second-master')

from second.data.nuscenes.utils.data_classes import LidarPointCloud, RadarPointCloud, Box
from second.data.nuscenes.utils.geometry_utils import view_points, box_in_image, BoxVisibility
from second.data.nuscenes.utils.map_mask import MapMask
...
class NuScenes:
    ...
    def get_sample_data(self, sample_data_token: str,
        ...
        data_path = self.get_sample_data_path(sample_data_token)#'/home/lichao/v1.0-mini/samples/LIDAR_TOP/n008-2018-08-28-16-43-51-0400__LIDAR_TOP__1535489296047917.pcd.bin'
